        ...
        <body>
          <div class="print-container">
            ...
            <div class="highlight-bg p-4 border-b">
              ...
              <div class="text-sm accent-text">Mobile: <span class="font-medium">9913363829</span></div>
            </div>
            ...
            <table class="w-full">
              <thead>
                <tr class="table-header">
                  <th class="text-sm font-semibold uppercase text-left" style="width: 8%;">S.NO.</th>
                  <th class="text-sm font-semibold uppercase text-left" style="width: 40%;">ITEMS</th>
                  <th class="text-sm font-semibold uppercase text-center" style="width: 12%;">QTY.</th>
                  <th class="text-sm font-semibold uppercase text-right" style="width: 13%;">MRP</th>
                  <th class="text-sm font-semibold uppercase text-right" style="width: 13%;">RATE</th>
                  <th class="text-sm font-semibold uppercase text-right" style="width: 14%;">AMOUNT</th>
                </tr>
              </thead>
              <tbody>
                ${invoice.items.map((item, index) => `
                  <tr>
                    ...
                    <td class="text-sm text-right primary-text">${Math.round(item.price * 1.2)}</td>
                ...
                <tr class="table-footer">
                  ...
                  <td class="text-sm font-semibold text-center">
                ...
                <tr class="highlight-bg">
                  <td></td>
                  <td class="text-sm font-semibold" style="color: #7C3AED !important;">DISCOUNT</td>
                  <td></td>
                  <td></td>
                  <td></td>
                  <td class="text-sm font-semibold text-right" style="color: #DC2626 !important;">- ₹ ${invoice.discount.toFixed(0)}</td>
                </tr>
                ` : ''}
                ...
                <tr class="highlight-bg">
                  <td></td>
                  <td class="text-sm font-semibold" style="color: #7C3AED !important;">OTHER CHARGES</td>
                  <td></td>
                  <td></td>
                  <td></td>
                  <td class="text-sm font-semibold text-right" style="color: #7C3AED !important;">₹ ${invoice.otherCharges.toFixed(0)}</td>
                </tr>
                ` : ''}
              </tbody>
            </table>
              ...
              <div class="grid grid-cols-2 gap-4">
                ...
                <div class="flex items-end">
                  <div>
                    ...
                    <div class="text-sm accent-text" style="line-height: 1.4;">
                      ${convertAmountToWords(Math.floor(invoice.total))} Rupees Only
                    </div>
                  </div>
                </div>
            ...
            <!-- Signature Footer -->
            <div class="highlight-bg p-4 text-center border-t">
              <div class="signature-box">
                <div class="text-sm font-semibold primary-text mb-2">
              ...
              <div class="mt-2 text-sm accent-text">
